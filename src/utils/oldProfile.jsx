          ...
          <div className="doctordetails">
            {isLoading ? (
              ...
              <img
                src={
                  userData.avatar
                    ? `http://192.168.0.153:3000/uploads/${userData.avatar.file_name}`
                    : Person
                }
                data-bs-toggle="modal"
                data-bs-target={!userData.avatar ? "#editdialog" : null}
          ...
          <div className="generaldetails">
            <div className="detailsleft">
              <span>
                ...
                <span>{userData.pro_title}</span>
              </span>
              <span>
                <span className="label">Employment Status: </span>
                <span>{userData.employment_status}</span>
              </span>
              <span>
            ...
            <div className="detailsright">
              <span>
                ...
                <span>{userData.hospitalName}</span>
              </span>
              <span>
              ...
              <span>
                ...
                <span>shs. {userData.rate} / hr</span>
              </span>
            </div>
          </div>
        </div>
